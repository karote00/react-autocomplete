...
var ReactDropdownAutoComplete = function (_Component) {
  _inherits(ReactDropdownAutoComplete, _Component);

  function ReactDropdownAutoComplete(props) {
    _classCallCheck(this, ReactDropdownAutoComplete);

    var _this = _possibleConstructorReturn(this, (ReactDropdownAutoComplete.__proto__ || Object.getPrototypeOf(ReactDropdownAutoComplete)).call(this, props));
  ...
  return ReactDropdownAutoComplete;
}(_react.Component);
...
exports.default = ReactDropdownAutoComplete;
